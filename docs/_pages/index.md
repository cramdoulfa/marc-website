...
feature_row:
  ...
  - image_path: /assets/images/npr-gpb.jpeg
    alt: "placeholder image 2"
    title: "NPR"
...
<!---
 ...
 TODO open links in new tabs
    ...
    UPDATE:
    Sol 1: the plug-in is not supported in github pages... https://github.com/keithmifsud/jekyll-target-blank/issues/27
    Sol 2: other trick didn't seem to work either: https://jamie.evawin.uk/seo-friendly-nofollow-links-jekyll-github-pages/
    both solutions above work locally but not on the gitHub pages built. One solution could be to serve the local build:
    ...
    SOLUTION is still to add {:target="_blank"} behind the link, in the markdown. Annoying cause doesn't work for links generated by the theme (cards, sidebar...)
...
<br><br>
Marc Faddoul regularly advises regulators with technical perspectives on AI ethics and platform accountability,
...
<br><br>
He is [often called upon](#in-the-news) to comment on AI and society by WSJ, The Guardian, Le Monde and more.
<br><br>
...
[MIMS:](https://www.ischool.berkeley.edu/programs/mims){:target="_blank"} Transdisciplinary program on societal, legal and ethical impacts of technology on society.
...
**French Senat** - Mar 23: [Audition (video):](https://videos.senat.fr/video.3332178_640f214f9aa6b.marc-faddoul-decrypte-l-algorithme-de-tiktok){:target="_blank"} *Special Commission on TikTok*
